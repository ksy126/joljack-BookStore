...
<head>
	...
	<!-- Bootstrap Core CSS -->
	<link href="<%=cp%>/css/adminCss/bootstrap.css" rel="stylesheet">
	<!-- Custom CSS -->
	<link href="<%=cp%>/css/adminCss/sb-admin-2.css" rel="stylesheet">
	<!-- Morris Charts CSS -->
	<link href="<%=cp%>/css/adminCss/metisMenu.min.css" rel="stylesheet">
	<!-- Custom Fonts -->
