						...
						<div class="col-xs-6">
							...
							<ul class="list-group"
								...
								<c:forEach var="row" items="${noticeList}">
									<li class="list-group-item">${row.notice_title}<span
										class="badge">관리자</span></li>
								</c:forEach>
								<li class="list-group-item"
									style="border-bottom: 0px; border-left: 0px; border-right: 0px;">
									&nbsp;<span class="badge"> <a href="/main/notice.do"
										style="color: #fff;">공지사항 바로가기 &nbsp;<i
											class="fa fa-hand-o-right" aria-hidden="true"></i></a></span>
								</li>
							</ul>
						</div>
						<div class="col-xs-6">
							...
							<ul class="list-group"
								...
								<li class="list-group-item"
									style="border-bottom: 0px; border-left: 0px; border-right: 0px;">
									&nbsp;<span class="badge"> <a href="/main/qa.do"
										style="color: #fff;">Q & A 바로가기 &nbsp;<i
											class="fa fa-hand-o-right" aria-hidden="true"></i></a></span>
								</li>
							</ul>
						</div>
								...
								<div class="product-image-wrapper">
									<div class="single-products">
										<div class="productinfo text-center"
											onclick="navi.detailsPage('${row.product_no}')">
											<img src="/upload/img/${row.p_img}" alt="" />
											<p>${row.p_name}</p>
											<h2>
												<i class="fa fa-krw" aria-hidden="true"></i>${row.p_price}</h2>
										</div>
									</div>
								</div>
							</div>
