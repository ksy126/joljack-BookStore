...
<!-- 세션 없으면 메인페이지로 강제 이동 -->
<c:if
	test="${sessionScope.sessionData.memberInfo.getMember_no() == null || sessionScope.sessionData.memberInfo.getMember_no() ==''}">
	<script>
	...
	<section id="cart_items">
		<div class="container">
			<div class="panel panel-default"
				style="margin: 1.5em 5.5em 1.5em 5.5em;" align="center">
							...
							<tr>
								...
								<td class="cart_total" align="center">
									<h4 class="cart_total_price">
										<i class="fa fa-krw" aria-hidden="true"></i> ${row.quantity * row.p_price}
									</h4>
								</td>
								<td class="cart_delete" align="center">
									<a class="cart_quantity_delete" href="" onclick="app.cartDelete('${row.purchase_no}', '${row.quantity}', '${row.product_no}')">
