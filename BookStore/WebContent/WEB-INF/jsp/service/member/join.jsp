				...
				<div class="form-horizontal">
						...
						<div class="col-sm-6">
							<div class="input-group">
								<input type="text" class="form-control" id="user_id"
									placeholder="아이디를 입력하세요" /> <input type="hidden" value="false"
									id="idConfirm"> <span class="input-group-btn">
					...
					<div class="form-group">
						<label class="col-sm-3 control-label" for="inputPasswordCheck">비밀번호
							확인</label>
						<div class="col-sm-6">
							<input class="form-control" id="user_pwd_confirm" type="password"
								placeholder="비밀번호 확인">
						...
						<div class="col-sm-6">
							<div class="input-group">
								<input type="tel" class="form-control" id="phone"
									...
									value="false" id="phoneConfirm"> <span
							...
							<p style="margin-left: 1em; margin-top: 0.3em;">입력한 휴대폰 번호는
								[아이디/비밀번호] 찾기에 이용됩니다.</p>
						</div>
					</div>
					<div class="form-group">
							...
							<div class="input-group">
								<input class="form-control" id="zip_code" type="text"
									...
									<button class="btn btn-success" type="button"
										...
										주소 검색 &nbsp; <i class="fa fa-edit spaceLeft"></i>
									</button>
								</span>
							</div>
						</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-6">
							<input type="text" class="form-control" id="sub_address"
								placeholder="" />
						</div>
					</div>
					<div class="form-group">
