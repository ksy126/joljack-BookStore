			...
			<div class="row">
					...
					<div class="login-form">
						...
						<form onkeydown="javascript:if(event.keyCode==13){app.login();}">
							<input type="text" id="user_id" placeholder="아이디" /> <input
								type="password" id="user_pwd" placeholder="비밀번호" />
						</form>
				...
				<div class="col-sm-5 col-sm-offset-1">
					<div class="signup-form">
						<!--sign up form-->
						<h2>
							<strong>아직 UPNORMAL 회원이 아니신가요?</strong>
						</h2>
						<div align="center">
							<button class="btn btn-primary btn-block"
								onclick="app.moveJoin()">회원가입 바로가기</button>
						</div>
						<hr>
					</div>
					<!--/sign up form-->
					<div class="signup-form">
						<!--sign up form-->
						<h2>
							<strong>아이디/비밀번호를 잊으셨나요?</strong>
						</h2>
						<div align="center">
							<button type="button" class="btn btn-primary btn-block"
								data-toggle="modal" data-target="#myModal">아이디/비밀번호 찾기</button>
						</div>
						<hr>
					</div>
					<!--/sign up form-->
		...
		<div class="modal-dialog">
			...
			<div class="modal-content">
				...
				<div class="modal-body">
						...
						<div class="form-group">
							<div class="col-sm-12">
								<div class="input-group">
									<input class="form-control" id="userPhone" type="number"
										placeholder="Phone"> <span class="input-group-btn">
										<button class="btn btn-success" type="button"
											onclick="app.searchUserInfo()">
											찾기 &nbsp;<i class="fa fa-edit spaceLeft"></i>
										</button>
									</span>
								</div>
							</div>
					...
					<hr>
					<div class="form-horizontal" id="userInfoConfirm"
						style="display: none;">
						<div class="form-group">
							<label class="col-sm-3 control-label" for="inputPassword">아이디</label>
							<div class="col-sm-9">
								<input class="form-control" id="userIdInfo" type="text"
									readonly="readonly">
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input class="form-control" id="userPwdInfo" type="text"
									readonly="readonly">
							</div>
						</div>
					</div>
