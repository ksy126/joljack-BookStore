...
public class AdminController {
	...
	public ModelAndView productRegeist(HttpServletRequest request, HttpServletResponse response,
			@RequestParam Map<String, Object> map) throws Exception {
	...
	public ModelAndView questionDetails(HttpServletRequest request, HttpServletResponse response,
			@RequestParam Map<String, Object> map) throws Exception {
		QaVO qaVo = null;
	...
	public ModelAndView noticeRegeist(HttpServletRequest request, HttpServletResponse response,
			@RequestParam Map<String, Object> map) throws Exception {
	...
	public ModelAndView noticeDetails(HttpServletRequest request, HttpServletResponse response,
			@RequestParam Map<String, Object> map) throws Exception {
		NoticeVO noticeVo = null;
		noticeVo = mainService.noticeInfoGET(map);
